...
class Detector:
    def __init__(self, p_min=0.5, threshold_nms=0.3):
        ...
        print("dice_model.pt exists:", os.path.exists("./detection_module/dice_model.pt"))
        self.dice_model = YOLO("./detection_module/dice_model.pt")
        self.cube_model = YOLO("./detection_module/cube_model.pt")
    ...
    def __loadNetwork(self):
        self.network = cv2.dnn.readNetFromDarknet("./cfg/yolov4.cfg", "./cfg/yolov4.weights")
    ...
    def detect(self, image):
        ...
        for result in network_output:
            for detected_objects in result:
                ...
                # prevent return the dice result
                if class_current < 6:
                    continue
        ...
        if results:
            ...
            if hasattr(r, "boxes") and r.boxes is not None and len(r.boxes) != 0:
                ...
                for cls_id in cls_ids:
                    temp_class_numbers.append(cls_id)
                for conf in confs:
